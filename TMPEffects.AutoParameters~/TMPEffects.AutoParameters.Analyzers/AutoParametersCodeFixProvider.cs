...
namespace TMPEffects.AutoParameters.Analyzers
{
    ...
    public class AutoParametersCodeFixProvider : CodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            var nestedTypes =
                GetNestedTypesWithAttribute(root, semanticModel, Constants.AutoParametersStorageAttributeName);
            string name = nestedTypes.Any() ? nestedTypes.First().Name : Constants.DefaultStorageName;
