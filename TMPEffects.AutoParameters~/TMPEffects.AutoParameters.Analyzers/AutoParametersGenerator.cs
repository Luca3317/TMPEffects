...
#pragma warning restore RS2008 // Enable analyzer release tracking
            ...
            TypeDeclarationSyntax syntax, ISymbol symbol)
        {
            ...
            if (storage == null)
            {
                storageDecl = SyntaxFactory.ClassDeclaration(Constants.DefaultStorageName)
        ...
        {
            var storage = SyntaxFactory.ClassDeclaration(Constants.DefaultStorageName);
            return storage;
        }
            ...
            return SyntaxFactory.MethodDeclaration(
                ...
                .AddParameterListParameters(
                    SyntaxFactory.Parameter(SyntaxFactory.Identifier("cData"))
                        .WithType(SyntaxFactory.IdentifierName(Constants.CharDataName)),
                    SyntaxFactory.Parameter(SyntaxFactory.Identifier("context"))
                        .WithType(SyntaxFactory.IdentifierName(Constants.IAnimationContextName))
                )
                .WithBody(
                    SyntaxFactory.Block(
