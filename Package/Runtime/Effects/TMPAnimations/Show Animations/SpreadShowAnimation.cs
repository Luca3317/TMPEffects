...
{
    [AutoParameters]
    [CreateAssetMenu(fileName = "new SpreadShowAnimation",
        menuName = "TMPEffects/Animations/Show Animations/Built-in/Spread")]
    public partial class SpreadShowAnimation : TMPShowAnimation
    {
