    ...
    {
        [AutoParameters]
        [CreateAssetMenu(fileName = "new GenericShowAnimation",
            menuName = "TMPEffects/Animations/Show Animations/Generic Animation")]
        public sealed partial class GenericShowAnimation : TMPShowAnimation, IGenericAnimation
        {
            #region Editor stuff
