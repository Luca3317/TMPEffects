...
//     {
//         var list =  new ReorderableList(property.serializedObject, property.FindPropertyRelative("Clips"), true, false, true, true);
...
//     }
//
//     private void AddCallback(SerializedProperty property, ReorderableList rList) 
//     {
//         Debug.LogWarning("ADD");
//         var tracksProp = property.FindPropertyRelative("Tracks");
//         tracksProp.arraySize++;
//         tracksProp.GetArrayElementAtIndex(tracksProp.arraySize - 1).FindPropertyRelative("Clips").ClearArray();
//     }
//     
...
//             ElementHeightCallback(property, index);
//
//         reList = list;
//     }
//
//     private float ElementHeightCallback(SerializedProperty prop, int index)
//     {
//         return EditorGUI.GetPropertyHeight(prop.FindPropertyRelative("Clips").GetArrayElementAtIndex(index));
//     }
//
//     public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
//     {
...
//     public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
//     {
//         return EditorGUI.GetPropertyHeight(property.FindPropertyRelative("Clips"));
//         // EnsureList(property);
//         // return reList.GetHeight();
//     }
//
