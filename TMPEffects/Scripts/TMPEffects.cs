...
public class TMPEffects : MonoBehaviour
{
    ...
    [SerializeField] TMPCommandDatabase commandDatabase;
    ...
    //private void Awake()
    //{
    //    preprocessor = new TMPEffectPreProcessor(database, commandDatabase);
    //    SetTextPreprocessor();
    ...
    //    {
    //        Debug.Log("Already was a stack, just adding myself to it");
    //        (text.textPreprocessor as TextPreprocessorStack).AddPreprocessor(preprocessor);
    //    }
    //    else
    //    {
    //        TextPreprocessorStack stack = new TextPreprocessorStack();
    ...
    //    foreach (var args in preprocessor.commands)
    //    {
    //        Debug.Log("Command! " + args.name);
    //        commandDatabase.GetCommand(args.name).ExecuteCommand(args);
    //    }
    //}
