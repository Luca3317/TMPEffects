...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(BundleValidateParametersHookFix)), Shared]
    public class BundleValidateParametersHookFix : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds
        {
            get
            {
                ...
                (
                    TMPParameterBundleAnalyzer.DiagnosticId_207
                );
            }
        }
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    createChangedDocument: c =>
                        ImplementValidateParametersHook(context, symbol, context.Document, classDeclaration, c),
        ...
        private async Task<Document> ImplementValidateParametersHook(CodeFixContext context, INamedTypeSymbol symbol,
