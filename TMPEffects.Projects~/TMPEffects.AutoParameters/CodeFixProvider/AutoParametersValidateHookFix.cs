...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AutoParametersValidateHookFix)), Shared]
    public class AutoParametersValidateHookFix : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds
        {
            get
            {
                ...
                (
                    AutoParametersAnalyzer.DiagnosticId_900
                );
            }
        }
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    createChangedDocument: c => ImplementValidateHook(context, context.Document, classDeclaration, c, name),
        ...
        private async Task<Document> ImplementValidateHook(CodeFixContext context, Document document, ClassDeclarationSyntax classDeclaration,
