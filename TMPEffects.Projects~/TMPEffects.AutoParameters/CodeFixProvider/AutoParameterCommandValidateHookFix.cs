...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AutoParametersCommandValidateHookFix)), Shared]
    public class AutoParametersCommandValidateHookFix : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds
        {
            get
            {
                ...
                (
                    AutoParametersAnalyzer.DiagnosticId_903
                );
            }
        }
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    title: "Implement ValidateParameters hook",
                    createChangedDocument: c => ImplementValidateHook(context, symbol, context.Document, classDeclaration, c, name),
                    equivalenceKey: "Implement ValidateParameters hook"),
                diagnostic);
        }
        ...
        private async Task<Document> ImplementValidateHook(CodeFixContext context, INamedTypeSymbol symbol, Document document, ClassDeclarationSyntax classDeclaration,
            CancellationToken cancellationToken, string storageName)
        {
            ...
            var methodDeclaration = SyntaxFactory.MethodDeclaration(
                ...
                .WithLeadingTrivia(SyntaxFactory.CarriageReturnLineFeed, SyntaxFactory.Comment("// Called before validating auto-parameters"), SyntaxFactory.CarriageReturnLineFeed);
