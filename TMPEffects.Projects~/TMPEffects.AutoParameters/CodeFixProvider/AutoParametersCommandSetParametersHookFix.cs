...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AutoParametersCommandSetParametersHookFix)), Shared]
    public class AutoParametersCommandSetParametersHookFix : CodeFixProvider
    {
        public override ImmutableArray<string> FixableDiagnosticIds
        {
            get
            {
                ...
                (
                    AutoParametersAnalyzer.DiagnosticId_904
                );
            }
        }
