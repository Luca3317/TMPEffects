...
namespace TMPEffects.AutoParameters
{
    public static class Utility
    {
            ...
            AttributeData attrData)
        {
            ...
            if (!Strings.SupportedTypes.TryGetValue(fieldSymbol.Type.ToDisplayString(), out string typeString))
            {
        ...
        private static StatementSyntax GetArrayValidationSyntax(string parametersName, IArrayTypeSymbol fieldSymbol,
            AttributeData attrData)
        {
            if (!Strings.SupportedTypes.TryGetValue(fieldSymbol.ElementType.ToDisplayString(), out string typeString))
            {
        ...
        {
            if (!Strings.SupportedTypes.TryGetValue(arrayTypeSymbol.ElementType.ToDisplayString(),
